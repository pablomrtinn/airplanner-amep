...
namespace AirPlanner {
	...
	/// </summary>
	public ref class FormModificarReserva : public System::Windows::Forms::Form
	{
	private:
		String^ idVol;
		int  seientFila;
	...
	private: System::Windows::Forms::GroupBox^ groupBox1;
		   float preuReserva;
	public:
		FormModificarReserva(String^ idV, String^ origenVol, String^ destiVol, String^ dataVolReserva, int seientF, char seientC, String^ nomReserva, String^ tipusEquipatgeReserva, float preu)
		{
			InitializeComponent();
...
#pragma region Windows Form Designer generated code
		...
		{
			System::ComponentModel::ComponentResourceManager^ resources = (gcnew System::ComponentModel::ComponentResourceManager(FormModificarReserva::typeid));
			...
			this->monthCalendar1->Location = System::Drawing::Point(536, 340);
			...
			this->label4->Location = System::Drawing::Point(93, 340);
			...
			this->comboBox2->Location = System::Drawing::Point(536, 258);
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 27.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(93, 249);
			...
			this->comboBox1->Location = System::Drawing::Point(536, 185);
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 27.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(93, 176);
			...
			this->textBox1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->textBox1->Location = System::Drawing::Point(536, 108);
			...
			this->label1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 27.75F, System::Drawing::FontStyle::Regular, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->label1->Location = System::Drawing::Point(93, 97);
			...
			this->TITOL->Location = System::Drawing::Point(568, 79);
			...
			this->button1->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 26.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button1->Location = System::Drawing::Point(170, 919);
			this->button1->Name = L"button1";
			this->button1->Size = System::Drawing::Size(230, 71);
			this->button1->TabIndex = 29;
			this->button1->Text = L"Cancel·lar";
			this->button1->UseVisualStyleBackColor = false;
			this->button1->Click += gcnew System::EventHandler(this, &FormModificarReserva::button1_Cancel);
			// 
			// button2
			// 
			...
			this->button2->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 26.25F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->button2->Location = System::Drawing::Point(1469, 919);
			this->button2->Name = L"button2";
			this->button2->Size = System::Drawing::Size(230, 71);
			this->button2->TabIndex = 30;
			this->button2->Text = L"Continua";
			this->button2->UseVisualStyleBackColor = false;
			this->button2->Click += gcnew System::EventHandler(this, &FormModificarReserva::button1_Continua);
			// 
			// labelInfoVol
			// 
			...
			this->labelInfoVol->Font = (gcnew System::Drawing::Font(L"Microsoft Sans Serif", 15.75F, System::Drawing::FontStyle::Bold, System::Drawing::GraphicsUnit::Point,
				static_cast<System::Byte>(0)));
			this->labelInfoVol->Location = System::Drawing::Point(6, 27);
			...
			// groupBox1
			// 
			this->groupBox1->Controls->Add(this->labelInfoVol);
			...
			this->groupBox1->Location = System::Drawing::Point(468, 206);
			this->groupBox1->Name = L"groupBox1";
			this->groupBox1->Size = System::Drawing::Size(978, 514);
			...
			this->Load += gcnew System::EventHandler(this, &FormModificarReserva::FormModificarReserva_Load);
...
#pragma endregion
		...
		private: System::Void FormModificarReserva_Load(System::Object^ sender, System::EventArgs^ e) {
			...
			try {
				...
				String^ correuManaged = gcnew String(correu.c_str());
				String^ volManaged = gcnew String(vol.c_str());

				PassarelaReserva reserva = cerca.cercaReserva(correu, vol, seientFila, seientColumna);
		...
		private: System::Void button1_Continua(System::Object^ sender, System::EventArgs^ e) {
			...
			if (form->ShowDialog() == System::Windows::Forms::DialogResult::Cancel) {
				...
				capaPresentacio.processarModificaReserva(seientFila, seientColumna, *vect, _idVol, _tipusEquipatge, _nom, _genere, _dataNeixement, preuReserva);
			}
			Launcher::Instance->formStack->Pop();
			this->Close();
		}
